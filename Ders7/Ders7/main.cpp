...
void IdleFunction(void)
{
	...
	if ( pad1x-0.1 < x && x < pad1x+0.1 && pad1y-0.2 < y && y < pad1y+0.2 )
	{
		directionX *= -1;
	}
	if ( pad2x-0.1 < x && x < pad2x+0.1 && pad2y-0.2 < y && y < pad2y+0.2)
	{
		directionX *= -1;
	}
...
void setupScene(){
	...
	pad1 = new ScreenSpaceShaderNode("bunny.obj");
    
	pad2 = new ScreenSpaceShaderNode("bunny.obj");
    
	ball = new ScreenSpaceShaderNode("sphere.obj");
